...
const API_ENDPOINT = '/api/uploading/endpoint'; 
...
const UploadImg: React.FC = () => {
  ...
  //handles selecting image files from user device
  ...
  // Simulates the upload process to AWS server.
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 sm:p-8 flex items-center justify-center font-sans">
      <div className="w-full max-w-2xl bg-white shadow-xl rounded-2xl p-6 md:p-10 border border-gray-200">
        
        <h1 className="text-3xl font-extrabold text-gray-900 mb-2 flex items-center">
          <Upload className="w-8 h-8 mr-3 text-indigo-600" />
          Upload Map Image for Campaigns
        </h1>
        <p className="text-gray-600 mb-8">
          Select an image (JPEG, PNG, etc.) to upload as your maps. The Max size is: {MAX_FILE_SIZE_MB}MB.
        </p>
